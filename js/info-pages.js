  ...
  const infoPages = {
    ...
    addListing: {
      ...
      body: `
        <p>BairX дээр зар нэмэхийн тулд та бүртгэлтэй (нэвтэрсэн) байх бөгөөд зар дээрээ холбогдох утасны дугаараа заавал бичнэ. Үүнээс өмнө дараах мэдээллийг бэлтгэнэ үү:</p>
